...
void GetMinRowArray(int[] array) // функция получения индекса с минимальным числом в массиве
{
    ...
    Console.Write("Следующие строки содержат наименьшую сумму элементов: "); // выводим строку

    for(int i = 0; i < array.Length; i++) // цикл для перечисления всех строк с минимальными значениями, если их несколько
    {
...
GetMinRowArray(myArray); // выводим ответ